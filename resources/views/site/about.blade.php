...
<section class="section overflow-hidden">
    <div class="container-site grid items-center gap-12 lg:grid-cols-2">
        ...
        @if($about->cover_image_path)<img src="{{ route('media', ['path' => $about->cover_image_path]) }}" alt="{{ $about->title }}" class="aspect-[4/3] w-full rounded-2xl object-cover shadow-soft">@endif
    </div>
</section>
